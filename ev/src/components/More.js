  ...
  return(
    <div>
      <div className="morecard">
        ...
        <p className='morep'>You will be asked 6 questions to determine how suitable electric car is for you.</p>
        <p className='morep'>After answering these questions you will be provided with a score out of 100. If your score is 70 or more then an Electric Car would most likely be right for you.
          If you score is between 30 and 70 then an electric car might be right for you but you might want to do some more research into it.
